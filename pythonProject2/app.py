...
music_dict = pickle.load(open(r'C:\Users\kalan\OneDrive\Desktop\project\musicrec.pkl', 'rb'))
music = pd.DataFrame(music_dict)

similarity = pickle.load(open(r'C:\Users\kalan\OneDrive\Desktop\project\similarities.pkl', 'rb'))
